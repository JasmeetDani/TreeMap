...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UILineRenderer : UIPrimitiveBase
	{
        ...
        // Edit : Jasmeet
        internal List<Vector2> m_points = new List<Vector2>();
...
#region Edit:Jasmeet
        ...
        public void InsertPoint(Vector2 pt)
        {
            m_points.Insert(m_points.Count - 1, pt);
            SetAllDirty();
        }
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
		{
            ...
            // Edit : Jasmeet
            Vector2[] pointsToDraw = m_points.ToArray();
            ...
            // Edit : Jasmeet
            if (BezierMode != BezierType.None && BezierMode != BezierType.Catenary && m_points.Count > 3)
            {
            ...
            // Edit : Jasmeet
            if (BezierMode == BezierType.Catenary && m_points.Count == 2)
            {
